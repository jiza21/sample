...
<body background="img/b.png">
	...
	<div class="ordermain">
		...
		<table >			
			<tr>
				<td>Price: </td>
				<td><input type="text" id="price" name="price" disabled="input"></td>
			</tr>
			<tr>
				<td>Quantity: </td>
			...
			<tr>
				...
				<td><input type="text" id="discount" name="discount" disabled="input"></td>
			</tr>
			<tr>
				<td>Discounted Amount: </td>
				<td><input type="text" id="discounted" name="discounted" disabled="input"></td>
			</tr>
			<tr>
				<td>Total Quantity: </td>
				<td><input type="text" id="tqty" name="tqty" disabled="input"></td>
			</tr>
			<tr>
				<td>Total Bills: </td>
				<td><input type="text" id="total" name="total" disabled="input"></td>
			</tr>
			<tr>
				<td>Cash Given: </td>
			...
			<tr>
				<td>Change: </td>
				<td><input type="Text" id="changemoney" name="changemoney" disabled="input"></td>
			</tr>
		</table>
		</div>
		<div class="iteminfo">
			<br/>
			<center><textarea rows="10" cols="25" id="item" name="item"></textarea></center>
		</div>
		</div>	
		<div class="buttons">
